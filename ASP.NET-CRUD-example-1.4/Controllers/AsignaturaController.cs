...
namespace ASP.NET_CRUD_example_1._4.Controllers
{
    public class AsignaturaController : Controller
    {
        ...
        public AsignaturaController(aspnetcrudexample13Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,AsignaturaNombre")] Asignatura asignatura)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,AsignaturaNombre")] Asignatura asignatura)
        {
            if (id != asignatura.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'aspnetcrudexample13Context.Asignaturas'  is null.");
            }
            var asignatura = await _context.Asignaturas.FindAsync(id);
            if (asignatura != null)
            {
